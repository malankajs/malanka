...
//     });
//
//     it('can render with childs', function () {
//         class Test extends Component {
//             prepare() {
//                 this.child({tagName: 'span'});
//             }
//         }
//
//         expect(env.render(new Test()).toString()).to.equal('<div><span></span></div>');
//     });
//
//     it('can render region', function () {
//         class Test extends Component {
//             prepare() {
//                 this.region('test');
//             }
//         }
//
//         expect(env.render(new Test({test: new Component()})).toString()).to.equal('<div><div></div></div>');
//     });
//
// });