...
describe('TemplateNodeTemplate', function () {
    ...
    it('template usage', function () {
        ...
        expect(result).to.equal('module.exports = function(context){var v0=function(tpl){return "test"};return __mergeStrings([" ",context.test.call(context,v0,{"hash":{}})], context)}');
    });

    it('template usage as helper', function () {
        let result = compiler.compileToString('{{#> tpl}}test{{/tpl}} {{tpl {} }}').split('\n').pop();

        expect(result).to.equal('module.exports = function(context){var v0=function(tpl){return "test"};return __mergeStrings([" ",v0({})], context)}');
    });
    ...
    it('template usage as helper with several params ', function () {
        ...
        expect(result).to.equal('module.exports = function(context){var v0=function(tpl){return "test"};return __mergeStrings([" ",v0({"a":1,"b":2})], context)}');
    });
    ...
    it('template usage as helper with several params and var', function () {
        ...
        expect(result).to.equal('module.exports = function(context){var v0=function(tpl){return "test"};return __mergeStrings([" ",v0(Object.assign({"a":1},context.test,{"b":2}))], context)}');
    });

    it('template usage as helper with several params and var', function () {
        let result = compiler.compileToString('{{#> tpl}}test{{/tpl}} {{tpl test {b:2} }}').split('\n').pop();

        expect(result).to.equal('module.exports = function(context){var v0=function(tpl){return "test"};return __mergeStrings([" ",v0(Object.assign({},context.test,{"b":2}))], context)}');
    });

    it('template usage as helper with hash', function () {
        let result = compiler.compileToString('{{#> tpl}}test{{/tpl}} {{tpl test=1}}').split('\n').pop();

        expect(result).to.equal('module.exports = function(context){var v0=function(tpl){return "test"};return __mergeStrings([" ",v0({"test":1})], context)}');
    });
    ...
    it('template usage as helper with hash and param', function () {
        ...
        expect(result).to.equal('module.exports = function(context){var v0=function(tpl){return "test"};return __mergeStrings([" ",v0({"a":1,"test":1})], context)}');
    });

    it('template usage as block helper', function () {
        let result = compiler.compileToString('{{#> tpl}}test{{/tpl}} {{#tpl {a:1} }}test{{/tpl}}').split('\n').pop();

        expect(result).to.equal('module.exports = function(context){var v0=function(tpl){return "test"};return __mergeStrings([" ",v0({"a":1,"content":"test"})], context)}');
    });
