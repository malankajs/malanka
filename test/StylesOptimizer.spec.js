...
describe('StylesOptimizer', function () {
    ...
    it('transform class with block helpers', function () {
        ...
        expect(result).to.equal('module.exports = function(context){return new Component({"attributes":{"class":(function(v0){return v0.mutate(function(){return __join(__mergeStrings([context.styles.test1," ",context.if.call(context,context.test,{"hash":{},"isString":true,"content":function(){return __mergeStrings([" ",v0], context)}})], context))})})(context.proxy("v1"))}})}');
    });
