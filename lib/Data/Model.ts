...
import {ModelOptions} from '../declarations';

@Prototype({
    idAttribute: 'id'
})
export class Model extends Events {
    private _proxies : Object;
    private _options : ModelOptions;
    private initialize : (attrs:Object, options?:ModelOptions) => void;
     ...
     */
    constructor(attrs?, options = ({} as ModelOptions)) {
        super();
