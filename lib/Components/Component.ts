...
import {ComponentOptions, TemplateFunction, TemplateContent} from '../declarations';
...
export class Component extends AbstractComponent {
    ...
    protected attributes:Object|(() => Object);
    protected template:TemplateFunction;
    protected content:TemplateContent|TemplateFunction;
    protected stateDefaults:Object;

    protected _className:string|ValueProxy<string>;
    protected _listenAttributes:Object;
    protected _state:Model;

    protected initialize:(options:ComponentOptions) => void;
    protected onRender:() => void;

    /**
     * @param {{[env]: Environment}} options
     */
    constructor(options = ({} as ComponentOptions)) {
        super(options);
     ...
     * @returns {Component[]}
     */
    protected renderContent(element = null) {
     ...
     * @returns {*[]}
     */
    protected prepareContent():TemplateContent[] {
     ...
     */
    protected prepareComponent(component):AbstractComponent {
     ...
     */
    public setAttributes(attributes, element = null) {
     ...
     */
    public setAttribute(key:string, attribute, {update = true} = {}) {
