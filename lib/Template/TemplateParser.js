module.exports = (function() {
  ...
  function peg$parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c107 = function(string) { return string },
        ...
        peg$c109 = function(attrs) { return attrs; },
        peg$c110 = "{{",
        peg$c111 = { type: "literal", value: "{{", description: "\"{{\"" },
        peg$c112 = "}}",
        peg$c113 = { type: "literal", value: "}}", description: "\"}}\"" },
        peg$c114 = function(open, path, params, hash, close) {
            return {
                type: 'Expression',
                path: path,
                params: params,
        ...
        peg$c117 = function(open, path, attributes, hash, close) {
            return {
                path: path,
                attributes: attributes,
                hash: hash
        ...
        peg$c120 = function(open, name, close) { return name; },
        peg$c121 = "{{else}}",
        peg$c122 = { type: "literal", value: "{{else}}", description: "\"{{else}}\"" },
        peg$c123 = function(content) { return content; },
        peg$c124 = function(start, content, inverse, close) {
        	if (start.path !== close) {
        ...
        peg$c129 = function(path, params, hash) {
        	return {
            	type: 'Expression',
                path: path,
                params: params,
        ...
        peg$c143 = function() { return {type: 'Primitive', value: false} },
        peg$c144 = "true",
        peg$c145 = { type: "literal", value: "true", description: "\"true\"" },
        peg$c146 = function() { return {type: 'Primitive', value: true} },
        peg$c147 = "null",
        peg$c148 = { type: "literal", value: "null", description: "\"null\"" },
        peg$c149 = function() { return {type: 'Primitive', value: null} },
        peg$c150 = "undefined",
        peg$c151 = { type: "literal", value: "undefined", description: "\"undefined\"" },
        peg$c152 = function() { return {type: 'Primitive', value: undefined} },
        peg$c153 = ".",
        peg$c154 = { type: "literal", value: ".", description: "\".\"" },
        peg$c155 = function(nums, d, n) { return d + n.join('') },
        peg$c156 = function(nums, d) {
            	return {type: 'Primitive', value: Number(nums.join('') + d)}
            },
        peg$c157 = function(nums) {
