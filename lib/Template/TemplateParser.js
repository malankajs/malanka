module.exports = (function() {
  ...
  function peg$parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c105 = function(value) { return value },
        peg$c106 = function(path) { return path; },
        peg$c107 = function(helper) { return helper; },
        peg$c108 = function(string) { return string; },
        peg$c109 = function(attributes) { return attributes },
        peg$c110 = function(path) { return path },
        peg$c111 = function(string) { return string },
        ...
        peg$c113 = function(attrs) { return attrs; },
        peg$c114 = "{{",
        peg$c115 = { type: "literal", value: "{{", description: "\"{{\"" },
        peg$c116 = "}}",
        peg$c117 = { type: "literal", value: "}}", description: "\"}}\"" },
        peg$c118 = function(open, path, params, hash, close) {
            return {
                type: 'Expression',
                path: path,
                params: params,
        ...
        peg$c121 = function(open, path, attributes, hash, close) {
            return {
                path: path,
                attributes: attributes,
                hash: hash
        ...
        peg$c124 = function(open, name, close) { return name; },
        peg$c125 = "{{else}}",
        peg$c126 = { type: "literal", value: "{{else}}", description: "\"{{else}}\"" },
        peg$c127 = function(content) { return content; },
        peg$c128 = function(start, content, inverse, close) {
        	if (start.path !== close) {
        ...
        peg$c133 = function(path, params, hash) {
        	return {
            	type: 'Expression',
                path: path,
                params: params,
        ...
        peg$c159 = function(nums, d, n) { return d + n.join('') },
        peg$c160 = function(nums, d) {
            	return {type: 'Primitive', value: Number(nums.join('') + d)}
            },
        peg$c161 = function(nums) {
