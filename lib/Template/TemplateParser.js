module.exports = (function() {
  ...
  function peg$parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c98 = function(path) { return path; },
        peg$c99 = function(helper) { return helper; },
        peg$c100 = function(string) { return string; },
        peg$c101 = function(attributes) { return attributes },
        peg$c102 = function(path) { return path },
        peg$c103 = function(string) { return string },
        ...
        peg$c105 = function(attrs) { return attrs; },
        peg$c106 = "{{",
        peg$c107 = { type: "literal", value: "{{", description: "\"{{\"" },
        peg$c108 = "}}",
        peg$c109 = { type: "literal", value: "}}", description: "\"}}\"" },
        peg$c110 = function(open, path, params, hash, close) {
            return {
                type: 'Expression',
                path: path,
                params: params,
        ...
        peg$c113 = function(open, path, attributes, hash, close) {
            return {
                path: path,
                attributes: attributes,
                hash: hash
        ...
        peg$c116 = function(open, name, close) { return name; },
        peg$c117 = "{{else}}",
        peg$c118 = { type: "literal", value: "{{else}}", description: "\"{{else}}\"" },
        peg$c119 = function(content) { return content; },
        peg$c120 = function(start, content, inverse, close) {
        	if (start.path !== close) {
        ...
        peg$c125 = function(path, params, hash) {
        	return {
            	type: 'Expression',
                path: path,
                params: params,
        ...
        peg$c135 = function() { return {type: 'Primitive', value: false} },
        peg$c136 = "true",
        peg$c137 = { type: "literal", value: "true", description: "\"true\"" },
        peg$c138 = function() { return {type: 'Primitive', value: true} },
        peg$c139 = "null",
        peg$c140 = { type: "literal", value: "null", description: "\"null\"" },
        peg$c141 = function() { return {type: 'Primitive', value: null} },
        peg$c142 = "undefined",
        peg$c143 = { type: "literal", value: "undefined", description: "\"undefined\"" },
        peg$c144 = function() { return {type: 'Primitive', value: undefined} },
        peg$c145 = ".",
        peg$c146 = { type: "literal", value: ".", description: "\".\"" },
        peg$c147 = function(nums, d, n) { return d + n.join('') },
        peg$c148 = function(nums, d) {
            	return {type: 'Primitive', value: Number(nums.join('') + d)}
            },
        peg$c149 = function(nums) {
